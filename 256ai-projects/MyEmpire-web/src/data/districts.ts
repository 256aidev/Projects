...
export const DISTRICTS: DistrictDef[] = [
  ...
  // ── Special interactive buildings ───────────────────────────────────────
  {
    id: 'casino_district',
    name: 'Lucky 7 Casino',
    description: 'Gamble dirty cash into clean winnings. The house always takes its cut.',
    themeColor: '#EAB308',
    revenueMultiplier: 0,
    operatingCostMultiplier: 0,
    customerTrafficMultiplier: 0,
  ...
  {
    id: 'jewelry_district',
    name: 'Ice Box Jewelers',
    description: 'Buy and upgrade jewelry for permanent passive bonuses.',
    themeColor: '#06B6D4',
    revenueMultiplier: 0,
    operatingCostMultiplier: 0,
    customerTrafficMultiplier: 0,
  ...
  // ── Rival Operations (non-playable, visual blocks) ────────────────────────
  {
    id: 'rival_ops_0',
    name: 'Rival Turf',
    description: 'Enemy territory. Rival gang operations.',
    themeColor: '#ef4444',
    revenueMultiplier: 0, operatingCostMultiplier: 0, customerTrafficMultiplier: 0,
    unlockCost: 0, policePresenceMultiplier: 0, auditChanceMultiplier: 0,
    maxBusinessSlots: 0,
    gridLayout: { rows: 3, cols: 2 },
