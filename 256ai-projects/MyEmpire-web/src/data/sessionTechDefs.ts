...
export const SESSION_TECH_DEFS: SessionTechDef[] = [
  {
    ...
    maxLevel: 3,
    costs: [
      { dirtyCash: 20_000,  cleanCash: 10_000,  productOz: 40 },
      { dirtyCash: 80_000,  cleanCash: 40_000,  productOz: 160 },
      { dirtyCash: 320_000, cleanCash: 160_000, productOz: 640 },
    ],
    effectPerLevel: 0.10,
  ...
  },
  {
    ...
    maxLevel: 3,
    costs: [
      { dirtyCash: 16_000,  cleanCash: 8_000,   productOz: 32 },
      { dirtyCash: 64_000,  cleanCash: 32_000,  productOz: 128 },
      { dirtyCash: 256_000, cleanCash: 128_000, productOz: 512 },
    ],
    effectPerLevel: 0.08,
  ...
  },
  {
    ...
    maxLevel: 3,
    costs: [
      { dirtyCash: 24_000,  cleanCash: 12_000,  productOz: 60 },
      { dirtyCash: 96_000,  cleanCash: 48_000,  productOz: 240 },
      { dirtyCash: 384_000, cleanCash: 192_000, productOz: 960 },
    ],
    effectPerLevel: 0.15,
  ...
  },
  {
    ...
    maxLevel: 3,
    costs: [
      { dirtyCash: 30_000,  cleanCash: 20_000,  productOz: 48 },
      { dirtyCash: 120_000, cleanCash: 80_000,  productOz: 192 },
      { dirtyCash: 480_000, cleanCash: 320_000, productOz: 768 },
    ],
    effectPerLevel: 0.10,
  ...
  },
  {
    ...
    maxLevel: 3,
    costs: [
      { dirtyCash: 18_000,  cleanCash: 12_000,  productOz: 40 },
      { dirtyCash: 72_000,  cleanCash: 48_000,  productOz: 160 },
      { dirtyCash: 288_000, cleanCash: 192_000, productOz: 640 },
    ],
    effectPerLevel: 0.10,
  ...
  },
  {
    ...
    maxLevel: 3,
    costs: [
      { dirtyCash: 12_000,  cleanCash: 6_000,   productOz: 80 },
      { dirtyCash: 48_000,  cleanCash: 24_000,  productOz: 320 },
      { dirtyCash: 192_000, cleanCash: 96_000,  productOz: 1280 },
    ],
    effectPerLevel: 50,
  ...
  },
  {
    ...
    maxLevel: 3,
    costs: [
      { dirtyCash: 8_000,   cleanCash: 4_000,   productOz: 20 },
      { dirtyCash: 32_000,  cleanCash: 16_000,  productOz: 80 },
      { dirtyCash: 128_000, cleanCash: 64_000,  productOz: 320 },
    ],
    effectPerLevel: 0.15,
  ...
  // ─── ROOM UPGRADE BOOSTERS — infinite +1% per level, cost doubles ───
  {
    ...
    costs: doublingSessionCosts(4_000, 2_000, 8, SESSION_ROOM_MAX),
    effectPerLevel: 0.01,
