 ...
 * Collects birth data from new users who signed in with Google/Apple
 */
...
export default function SocialOnboardingScreen() {
  const { completeOnboarding, cancelOnboarding, pendingSocialLogin, isLoading } = useAuth();

  const [name, setName] = useState(pendingSocialLogin?.name || '');
  ...
  const handleCancel = () => {
    Alert.alert(
      'Cancel Registration',
      'Are you sure you want to cancel? You can try signing in again later.',
      [
        { text: 'Continue', style: 'cancel' },
        { text: 'Cancel', style: 'destructive', onPress: cancelOnboarding },
      ]
    );
  };
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            BaZi astrology uses your exact birth details to calculate your Four Pillars
          </Text>
        </View>
        ...
        <View style={styles.form}>
          ...
          <Text style={styles.hint}>
            Exact time is important for accurate readings. Check your birth certificate if possible.
          </Text>
